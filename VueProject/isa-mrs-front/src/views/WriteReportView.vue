...
<script>
    ...
    export default({
        ...
        methods: {
            penalizeClient(){
                axios.post("https://isa-projekat-tim-3.herokuapp.com/reports/penalizeClient",{
            ...
            sendReport(){
                axios.post("https://isa-projekat-tim-3.herokuapp.com/reports/sendReport", {
                    reservationId: this.$route.params.id,
            ...
            askForPenal(){
                axios.post("https://isa-projekat-tim-3.herokuapp.com/reports/askForPenal", {
                    reservationId: this.$route.params.id,
                    comment: this.form.comment
                },
                {
