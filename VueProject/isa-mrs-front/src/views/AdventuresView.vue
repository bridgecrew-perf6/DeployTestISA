...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            search(form) {
                axios.get("https://isa-projekat-tim-3.herokuapp.com/services/search", {
                    params: {
                        name: form.name,
        ...
        mounted () {
            axios.get("https://isa-projekat-tim-3.herokuapp.com/adventures/getInstructorsAdventures/" + this.$route.params.id)
            .then(response => {
                this.searchResults = response.data;
                this.updateVisibleUsers();
            })
