    ...
    export default {
        ...
        methods: {
            cancelReservation(reservationId) {
                axios.put("https://isa-projekat-tim-3.herokuapp.com/reservations/cancelReservation/" + reservationId, {},
                {
                    headers: {
            ...
            getPendingReservations() {
                axios.get("https://isa-projekat-tim-3.herokuapp.com/reservations/getPendingReservations", {
                    headers: {
                        Authorization: 'Bearer ' + window.sessionStorage.getItem("accessToken")
                    }
                })
