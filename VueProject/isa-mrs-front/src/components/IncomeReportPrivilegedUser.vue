...
<script>
    ...
    export default {
        ...
        methods:{
            search(){
                axios.get("https://isa-projekat-tim-3.herokuapp.com/reservations/findInDateSpanPrivilegedUser?fromDate=" + this.fromDate + "&toDate=" + this.toDate,{
                    headers:{
                        Authorization: "Bearer " + window.sessionStorage.getItem("accessToken")
                    },
                }).then((response) => {
                    this.reservations = response.data;
                    axios.post("https://isa-projekat-tim-3.herokuapp.com/reservations/calculateMyIncome", {
            ...
            showAll(){
                axios.get("https://isa-projekat-tim-3.herokuapp.com/reservations/findUsersNonCancelledReservations",{
                    headers:{
                        Authorization: "Bearer " + window.sessionStorage.getItem("accessToken")
                    }
                }).then((response) =>{
