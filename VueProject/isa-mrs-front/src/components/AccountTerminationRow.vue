...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            declineTermination(){
                axios.post("https://isa-projekat-tim-3.herokuapp.com/termination/declineTermination",
                {
            ...
            acceptTermination(){
                axios.post("https://isa-projekat-tim-3.herokuapp.com/termination/acceptTermination",
                {
                    userId: this.termination.userId,
