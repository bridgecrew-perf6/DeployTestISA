...
export default {
    ...
    mounted(){
        axios.get("https://isa-projekat-tim-3.herokuapp.com/reservations/yearlyReport", {
            headers: {
        ...
        axios.get("https://isa-projekat-tim-3.herokuapp.com/reservations/monthlyReport",{
            headers:{
                Authorization: 'Bearer ' + window.sessionStorage.getItem('accessToken')
            }
        }).then((response) => {
        ...
        axios.get("https://isa-projekat-tim-3.herokuapp.com/reservations/weeklyReport",{
            headers:{
                Authorization: 'Bearer ' + window.sessionStorage.getItem('accessToken')
            }
        }).then((response) => {
